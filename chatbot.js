        ...
        <div class="bg-[#03a84e] flex flex-col justify-between shadow-lg overflow-hidden rounded-2xl w-[500px] h-[578px]">
          <div class="flex flex-col items-center space-y-3 pt-4 px-6">
            ...
            <div class="bg-white text-black h-32 rounded-xl py-4 px-4 space-y-2 w-full">
              ...
              <div class="relative">
                <input class="appearance-none border pl-10 border-gray-300 hover:border-gray-400 transition-colors rounded-md w-full py-4 px-3 text-gray-800 leading-tight focus:outline-none focus:ring-green-600 focus:border-green-600 focus:shadow-outline placeholder:text-sm placeholder:text-gray-800" type="text" placeholder="Search KB for answer" />
                <div class="absolute left-0 inset-y-0 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-3 text-gray-400 hover:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div id="messageDiv" class="hidden absolute right-5">
        <div class="w-[500px] h-[578px] flex flex-col bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div class="flex-1 p-4 space-y-4">
            ...
            <div id="chatBtn2" class="bg-white border text-black h-20 rounded-xl flex px-4 justify-between items-center w-full cursor-pointer">
              <div>
                <h2 class="text-lg font-bold">New Conversation</h2>
                <p class="text-sm text-gray-500">We typically reply in a few minutes</p>
              </div>
